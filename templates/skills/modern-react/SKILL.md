---
name: modern-react
description: Modern React patterns and best practices including hooks, composition, and performance. Use when building React components, managing state, writing custom hooks, or when user asks about "React hooks", "component patterns", "React performance", or "state management".
category: frontend
