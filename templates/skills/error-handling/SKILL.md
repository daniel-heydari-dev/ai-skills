---
name: error-handling
description: Patterns for robust error handling including custom errors, Result types, and retry logic. Use when implementing error handling, creating custom error classes, building resilient APIs, or when user asks about "error handling", "try-catch", "Result type", or "error boundaries".
category: fundamentals
tags: [error-handling, errors, result-type, resilience, try-catch]
---
