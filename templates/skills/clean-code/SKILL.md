---
name: clean-code
description: Principles for writing readable, maintainable, and simple code. Use when writing new functions, refactoring existing code, doing code reviews, or when user asks about "naming conventions", "code readability", "clean code", or "code quality".
category: fundamentals
tags: [clean-code, naming, readability, refactoring, code-quality]
---
